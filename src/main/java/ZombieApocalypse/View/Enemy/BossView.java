...
//Animazioni disponibili per il boss
    ...
    public void update()  {
        ...
        if (enemyModel.dying) { //Gestione della morte
        ...
        if (!enemyModel.hit) {  //Gestione del Movimento
            if (enemyModel.isMoving) {  //in movimento
                switch (enemyModel.dir) {
                    case LEFT -> {
        ...
        } else { //Gestione dei movimenti durante una hit
            if (count == 2) {
                switch (enemyModel.dir) {
                    case LEFT -> {
