...
public class ResultsPanel {
        ...
        btnMenu.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                executor.execute(new Runnable() {
                    @Override
                    public void run() {
                        try { saveData(); } catch (IOException ex) { showConnectionError(); } finally { GameData.punti = 0; }
                    }
                });
    ...
    public void showConnectionError() {
        ...
        JButton btnMenu = new JButton("OK");
        if(GameData.lang.equals(GameData.Language.IT))
            label.setText("<html>Nessuna connessione ad internet rilevata.<br>Potrai continuare a giocare tuttavia i dati non saranno salvati e la classifica non sarà aggiornata!</html>");
        else
            label.setText("<html>No internet connection detected.<br>You can continue playing however the data will not be saved and the ranking will not be updated!</html>");
